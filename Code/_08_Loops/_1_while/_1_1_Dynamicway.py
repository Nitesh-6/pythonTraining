...
# BEHAVIOR
'''
unit 1 : Validate input marks
unit 2 : Get student result
unit 3 : Get division 
unit 4 : cent marks 
'''
# I. Develop unit wise, Test it
# II. Skeleton Structure
...
----------------------------------------------------------------------------------------------
    T1. Give lower,upper value and _0_str_len_1      Print numbers b/w     As Expected          PASS 
    T2. Give upper,lower value and _0_str_len_1      Should dispaly error  Its not displaying   FAIL
'''
