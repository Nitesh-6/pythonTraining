...
''' Requirement : Adding Numbers 
    =================================
    Usecases:
        I. Count   : Only 2 numbers or more
       II. Type    : Only Positive or only Negative or both Pos,Neg
      III. Datatype: Only Int. Int/Float
       IV. Zero    : 0 is allowed or not 
