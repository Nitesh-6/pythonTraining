...
No readability
No  reusability
Enhancements will be difficult 
'''
# I. Readability
print("Employee ID  : ", 10)
# II. Reusability
e_id = 10
print("Employee ID  : ", e_id)

# III. Enhancements will be difficult(Load dynamically)
e_id = input("Enter employee id : ")
print("Employee ID  : ", e_id, type(e_id))

e_id = int(input("Enter employee id : "))  # 10  --> "10"  --> int()
print("Employee ID  : ", e_id, type(e_id))
...
'''
Rules:
- Dont write print statement with only values    print(10)
       ===>  Write proper print statements with meaningful information 
                                                 print("Employee ID : ", 10)   
- Dont directly use value/expression in print statement  print("Value:", x**2)  
       ===>  Do assign value/expression to variable  res = x**2 print("Value:", res)
                 
'''
# REQ: Get cube of given value
'''
Entity : Number 
State : given value 
Behavior: Get cube 
...
# Behavior
cube = val ** 3
print("Cube of value : ", cube)

# REQ: Give result of addition of numbers
'''
Entity: Addition
State: given numbers 
Behavior: Give addition result 
'''
# State
num1 = 10
num2 = 20
...
val = 10  # hardcoding
sq_val = val ** 2
print("Square of val  ", sq_val)

val = input("Enter value : ")  # 10 "10" int()  10
sq_v = val ** 2
print("Square of val : ", sq_v)

val = int(input("Enter value : "))  # 10 "10" int()  10
sq_v = val ** 2
print("Square of val : ", sq_v)
...
'''
    1. Dont hardcode x value  
    2. Use int function directly at input 
    3. Store addition result into a variable 
    4. Use proper naming conventions for variables
'''
# Code Refactoring
...
x = 10  # Dynamic way of initialization
y = 20
res = x + y
print("Addition is : ", res)
...
# Code Review : CR Comments
'''
Change variable names something like num1, num2
Instead of output var, use a meaningful name 
'''
# Changes: Code Refactoring
num1 = int(input("Enter number1 : "))  # 10 --> '10'  --> 10
