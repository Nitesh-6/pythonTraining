...
# REQUIREMENT : Get student result (Pass/Fail) based on given input marks.
                ------------------  -----------       ------------------
                  Requirement         Behavior                State
            
            Conditions: marks should be between 0 to 100.It should be integer.
            Criteria: >= 35 : PASS <35: FAIL
...
3. Get result based on conditional data 
Unit Testing        : Complete each task and do unit testing 
Integration Testing : Test all usecases again 

# BEHAVIOR
 # 1. crud          : CREATE
 # 2. Validations   : should be between 0 to 100
 # 3. Businses logic: Operators, DM,      Loops
 #                      > <=       if else

'''

# State: given input marks. : Data types/structures
marks = float(input("Enter marks : "))   # 50
print("Given marks are : ", marks)
# Behavior : Operators, DM, Loops:   Get student result(Pass/Fail)
if marks >= 0 and marks <= 100:  # -1 0 1 99 100 101 55 -15  125
    print("Given marks are Valid ")
    ...
    print("Given marks are invalid")

print("--------End of Program---------")

# ENHANCEMENT:
# REQ: Along with student result, I need division of student.
...
2.1. Functional Analysis
       - Existing Functionality(Through UI)
       - Expected Functionality
2.2. Technical Analysis 
       - Find code for existing functionality 
       - Do code walkthrough
       - Do code changes for expected functionality
'''
...
if marks >= 0 and marks <= 100:  # -1 0 1 99 100 101 55 -15  125
    ...
    if marks >= 35:  # 34 35 36 20 60
        print("Result : PASS")
        if marks >= 60:     # 59 60 61 49 50 51 34 35 36
            print("First Class")
        elif marks >= 50:
            print("Second Class")
        else:
